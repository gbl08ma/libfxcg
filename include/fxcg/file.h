...
void Bfile_NameToStr_ncpy(unsigned char*source, const unsigned short*dest, size_t n);
void Bfile_StrToName_ncpy(unsigned short *dest, const unsigned char *source, size_t n);
